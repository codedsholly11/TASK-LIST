    ...
    <Nav/>
     <div className='w-[100%] h-[100vh] flex flex-col items-center text-center  py-[20px]'>
        <div className='flex flex-col   bg-[#ffffff]  gap-[40px]'>
            ...
            <div>
                <p className='text-start text-xl'>Full Name</p>
                <input className='md:w-[30vw] w-[90vw] py-[8px] bg-[#e5f4fb] px-[10px] rounded-lg ' type="text" name='name' placeholder='full name' />
            </div>
            <div>
            ...
            <div>
            <button className='bg-[#bf616a] md:w-[18vw] w-[90vw] py-[8px] rounded-lg'>Let's start</button>
            </div>
            <div>
