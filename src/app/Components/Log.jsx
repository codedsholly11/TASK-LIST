...
//             </div>
//             <div>
//                 <button className='bg-[#bf616a] md:w-[18vw] w-[90vw] py-[8px] rounded-lg'>Log in</button>
//             </div>
//             <div>
//                 <p className=' '>Don't have an account <span className='text-[#bf616a] text-[15px] font-bold'>Sign up</span></p>
//             </div>
//         </div>
